...
public class LinkController {
    ...
    @PostMapping("/save")
    @ResponseBody
    public Map<String,Object> save(@RequestBody AdvertEntity link){
        log.info("新增：{}",link.toString());
        Map<String,Object> rstMap = new HashMap();  //返回数据
        try {
            this.advertService.addAdvert(link);
        } catch (Exception e) {
            e.printStackTrace();
            rstMap.put("code","300");
